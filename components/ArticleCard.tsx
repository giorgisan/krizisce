...
export default function ArticleCard({ news }: Props) {
  ...
  return (
    <div className="relative"> {/* <-- WRAPPER za absolutno 'oko' */}
      {/* Kartica kot <a> ostane enaka in je 'group' tarča */}
      <a
        href={news.link}
        target="_blank"
      ...
      {/* OKO – ABSOLUTNI SIBLING (NI več znotraj <a>) */}
      <span
        role="button"
        tabIndex={0}
        onClick={(e) => {
        ...
        className="
          eye-zoom
          absolute top-2 right-2 z-10 h-8 w-8 grid place-items-center rounded-full
      ...
      {/* Tooltip – “Predogled novice” (desktop, hover očesa) */}
      <span
        className="
          ...
          md:hover:opacity-100 md:hover:translate-x-0
        "
      >
        Predogled&nbsp;novice
      </span>
