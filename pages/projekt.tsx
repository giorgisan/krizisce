      ...
      <main className="flex-grow w-full max-w-[1800px] mx-auto px-4 md:px-8 lg:px-16 py-12 text-gray-900 dark:text-white">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="text-lg leading-relaxed text-gray-600 dark:text-gray-300">
                ...
                <p className="mb-4">
                  V poplavi informacij je včasih težko ostati na tekočem. <strong>Križišče</strong> je nastalo z enim preprostim ciljem: izboljšati pregled nad slovensko medijsko krajino in bralcem prihraniti čas. Namesto da pregledujete deset različnih portalov, lahko najpomembnejše naslove preletite na enem mestu.
                </p>
