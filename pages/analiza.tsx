                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                    <div className="max-w-2xl">
                        ...
                        <p className="text-[14px] text-gray-500 dark:text-gray-400 leading-relaxed">
                            Odkrijte manipulacije v naslovih. Sistem destilira novice v nevtralen <strong>Konsenzni naslov</strong> in vizualizira <strong>Medijski DNK</strong> vsakega vira.
                        </p>
                    </div>
                    
                    <div className="flex items-center gap-3">
                        {lastUpdated && (
                            <div className="text-[11px] font-mono text-gray-500 flex items-center gap-2 border border-gray-200 dark:border-gray-700 px-3 py-1.5 rounded bg-gray-50 dark:bg-gray-800/50 shadow-sm">
