...
export default function Home({ initialNews }: Props) {
  ...
  return (
    <>
      ...
      <main
      className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white px-4 md:px-8 lg:px-16 pt-5 lg:pt-6 pb-24"
      style={{ transform: 'translateY(var(--mob-banner-y, 0px))', transition: 'transform .18s ease-out' }}
    >
