...
      if (Array.isArray(data)) return data // Vrni tudi prazen seznam, če je array
    }
  } catch {}
...
      }))
      return items.length ? items : [] // Vrni prazen seznam, če ni nič
    } catch {
      return null
    }
  }
...
          if (fresh) { // Opomba: Tudi prazen array je 'truthy'
            if (mode === 'latest') {
...
              setDisplayCount(40)
              setTrendingLoaded(true) // Dodano za konzistentnost
            }
          }
...
                </div>
             ) : (
                // Stanje: Nalagam ostale novice ali ni rezultatov po filtru
